                        ...
                        <View style={styles.exploreSection}>
                            ...
                            <View style={styles.exploreContent}>
                                <TouchableOpacity style={styles.singleExplore}
                                                  onPress={() => props?.navigation.navigate('Recharge', {card: cardSelect})}>
                                    <Ionicons name="cash-outline" size={22} color={theme.colors.primary}/>
                                    <Text style={styles.exploreText}>Recharge</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={styles.singleExplore}
                                                  onPress={() => props?.navigation.navigate('Transfer', {card: cardSelect})}>
                                    <SimpleLineIcons
                                        name="wallet" size={22}
                                ...
                                <TouchableOpacity style={styles.singleExplore}
                                                  onPress={() => props?.navigation.navigate('Historique', {card: cardSelect})}>
                                ...
                                <TouchableOpacity style={styles.singleExplore}
                                                  onPress={() => props?.navigation.navigate('QrCode', {card: cardSelect})}>
